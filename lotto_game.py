...
class Game:
    """
    Лото - это игра, в которой игроки получают карточки с набором чисел
    и отмечают их при вытаскивании из мешка чисел. В мешке находятся 90
    бочонков с числами, которые вытаскиваются один за другим, и игроки
    отмечают числа на своих карточках, соответствующие числам на бочонках.
    Победитель - тот, кто первый заполнит все числа на своей карточке и
    закричит "Лото!". Варианты правил игры допускают различные варианты выигрышей.
    [©️ The program design and code were developed on 26.02.2023
    by Dmitry P. under the MIT license]
    """
    player_cards = []
    game_barrels = []
    card_colors = ['⬜️', '🟥', '🟨', '🟦', '🟧', '🟪', '🟫', '🟩']
