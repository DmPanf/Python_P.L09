...
info = """
    ...
    1    человек <-> компьютер
    2    человек <-> человек
    3-7  От 3 человек и до 7 (между собой)
"""
...
if __name__ == '__main__':
    ...
    while True:
        status, result = lotto_game.play_round(gamers_count) # Возвращается False (мгновенный проигрыш) или True (выигрыш) + номер Игрока
